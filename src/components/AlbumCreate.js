...
export default class AlbumCreate extends Component {
  ...
  onChangeFileUrl(newZphoto) {
    this.setState(
      ...
      () => {
        console.log('AlbumCreate File URL:', this.state.album.fileurl);
      }
    );
  }
  ...
  handleUploadTrackSuccess = (trackid, fileurl) => {
    this.addTrackToAlbum(trackid, fileurl);
  };
                ...
                <div>
                  <div className={styles.albumInfo}>
                    <div className={styles.customizeAlbumPhoto}>
                      <AlbumPhoto 
                        onChangeFileUrl={this.onChangeFileUrl}
                      />
                    </div>
                    <input
                      label="AlbumName"
